...
CREATE USER mykaizenfit_user WITH PASSWORD 'mykaizenfit_pass';
...
- **Admin**: admin@mykaizenfit.com / admin123
- **Trainer**: trainer@mykaizenfit.com / trainer123
- **User**: user1@mykaizenfit.com / user123
...
curl -X POST http://localhost:8000/api/auth/login/ \
  ...
  -d '{"email": "admin@mykaizenfit.com", "password": "admin123"}'
