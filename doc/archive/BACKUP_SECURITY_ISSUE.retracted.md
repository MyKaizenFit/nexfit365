> **RETRACTADO (2026-07-24).** `\restrict` / `\unrestrict` son metacomandos
> legítimos de PostgreSQL, no una inyección. No seguir las recomendaciones de
> filtrado de este archivo. Ver la corrección en
> [`BACKUP_SECURITY_ISSUE.md`](../../BACKUP_SECURITY_ISSUE.md) (raíz del repo).
...
**Estado:** ❌ RETRACTADO — análisis incorrecto
