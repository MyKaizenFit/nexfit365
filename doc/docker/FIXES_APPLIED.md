...
POSTGRES_PASSWORD=SUPER_PASSWORD  # ← Usado por db y db-backup

# docker/backend.env.production - Para Django
DB_NAME=mykaizenfit
DB_USER=postgres
DB_PASSWORD=SUPER_PASSWORD  # ← DEBE SER LA MISMA que POSTGRES_PASSWORD
POSTGRES_PASSWORD=SUPER_PASSWORD  # ← Opcional pero consistente
```
