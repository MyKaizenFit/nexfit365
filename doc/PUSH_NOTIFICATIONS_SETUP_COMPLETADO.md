...
```
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEfqnWlIIIdFQjZ0aZ07qt8WYXMlA57a2V4MnBfrg4aKpinObCXZ3VTuyMnK6Sldzwo5dcuyGhd499/MfPwEqRcw
```

### Clave Privada (VAPID_PRIVATE_KEY):
```
-----BEGIN PRIVATE KEY-----
MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgdYzlgLecndjj9Y26
E8REPzFxhVj29o6EEfkzLA/v2i6hRANCAAR+qdaUggh0VCNnRpnTuq3xZhcyUDnt
rZXgycF+uDhoqmKc5sJdndVO7IycrpKV3PCjl1y7IaF3j338x8/ASpFz
-----END PRIVATE KEY-----
```
...
```yaml
VAPID_PUBLIC_KEY: "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEfqnWlIIIdFQjZ0aZ07qt8WYXMlA57a2V4MnBfrg4aKpinObCXZ3VTuyMnK6Sldzwo5dcuyGhd499/MfPwEqRcw"
...
```yaml
NEXT_PUBLIC_VAPID_PUBLIC_KEY: "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEfqnWlIIIdFQjZ0aZ07qt8WYXMlA57a2V4MnBfrg4aKpinObCXZ3VTuyMnK6Sldzwo5dcuyGhd499/MfPwEqRcw"
```
