...
export function WorkoutPlansDashboard({ userProfile, onComplete }: WorkoutPlansDashboardProps) {
  ...
  const getLevelColor = (level: string) => {
    ...
    return colors[level as keyof typeof colors] || 'bg-gray-100 text-foreground'
  }
        ...
        <TabsContent value="my-plans" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {workoutPrograms.map((plan) => (
              <Card key={plan.id} className="border shadow-xl">
                <CardHeader>
          ...
          {activeProgram ? (
            <div className="space-y-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Días de entrenamiento</div>
                    </div>
                    <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {activeProgram.days?.map((day) => (
                  <Card key={day.id} className="border shadow-xl">
                    <CardHeader>
                        ...
                        <>
                          ...
                          <div className="space-y-2">
                            {day.exercises.slice(0, 3).map((exercise) => (
                              <div key={exercise.id} className="text-xs bg-muted p-2 rounded">
            ...
            <Card className="border shadow-xl">
              <CardContent className="p-12 text-center">
                <Dumbbell className="h-12 w-12 mx-auto mb-4 text-muted-foreground/70" />
