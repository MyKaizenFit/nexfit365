...
export function MealDebug() {
  ...
  return (
    <div className="p-6 bg-muted border border-border rounded-lg space-y-4">
      <h3 className="text-lg font-semibold text-foreground">🔍 Debug - Estado del Hook</h3>
      ...
      <div className="space-y-3">
        <h4 className="font-medium text-foreground">Comidas del Día:</h4>
        {meals.map((meal) => (
          <div key={meal.id} className="p-3 bg-card border border-border rounded">
      ...
      <div className="p-3 bg-green-50 border border-green-200 rounded">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            ...
            <div className="text-muted-foreground">Proteína (g)</div>
          </div>
          <div>
            <div className="font-medium text-green-600">
              {macros.carbsConsumed} / {macros.carbsGoal}
            </div>
            <div className="text-muted-foreground">Carbohidratos (g)</div>
          </div>
          <div>
            <div className="font-medium text-yellow-600">
              {macros.fatConsumed} / {macros.fatGoal}
            </div>
            <div className="text-muted-foreground">Grasas (g)</div>
          </div>
        </div>
      </div>

      {/* Información de debug */}
      <div className="p-3 bg-gray-100 border border-gray-300 rounded text-xs text-muted-foreground">
