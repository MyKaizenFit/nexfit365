...
describe('dashboard navigation helpers', () => {
  ...
  it('hides Recomendaciones, Bienestar and Mi Perfil while keeping Descanso visible', () => {
  ...
  it('hides Recomendaciones while keeping Descanso in the desktop sidebar menu and the mobile more menu', () => {
    const desktopMenu = [
      { title: 'Inicio', url: 'dashboard' },
      { title: 'Recomendaciones', url: 'recommendations' },
      { title: 'Bienestar', url: 'wellness' },
  ...
  it('redirects direct Recomendaciones and Bienestar URLs without redirecting Descanso', () => {
