...
> 📚 **Documentación Completa**: Toda la documentación del backend está en [`../doc/backend/`](../doc/backend/)
...
Ver el [Índice de Documentación](../doc/INDEX.md) para acceder a toda la documentación del proyecto.
