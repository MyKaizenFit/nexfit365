...
def create_simple_nutrition_plans():
    """Crear planes de nutrición simples con los campos disponibles"""
    ...
    print("🍽️ Creando planes de nutrición de ejemplo...")
