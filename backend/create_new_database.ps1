# ============================================
# Script para crear nueva base de datos ddbb_nextfit
# ============================================
# Este script crea:
...
$AdminUser = "postgres"
$NewUser = "nexfit_app"
$NewPassword = '$ydEt4Kdpe012oB$07tArRak'
...
Write-Host "[INFO] Necesitamos la contraseña del usuario 'postgres' para crear la nueva BD" -ForegroundColor Yellow
Write-Host "   (Si no tienes contraseña, presiona Enter y se intentara sin contraseña)" -ForegroundColor Yellow
$AdminPassword = Read-Host "Contraseña de postgres (o Enter para intentar sin contraseña)" -AsSecureString
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "[AYUDA] Intenta ejecutar manualmente en psql:" -ForegroundColor Yellow
