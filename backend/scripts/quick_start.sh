...
show_final_info() {
    ...
    echo "   • Admin: admin@example.invalid / CHANGE_ME_PASSWORD"
    echo "   • Trainer: trainer@mykaizenfit.com / CHANGE_ME_PASSWORD"
    echo "   • User: user1@mykaizenfit.com / CHANGE_ME_PASSWORD"
    echo ""
